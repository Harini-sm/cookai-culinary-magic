        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            >
              ...
              <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
                A diverse group of culinary experts, AI engineers, and food enthusiasts
              </p>
            </motion.div>
          </div>
            ...
            {[
              {
                name: "Alex Chen",
                role: "Founder & CEO",
                image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=facearea&facepad=2&q=60&w=300&h=300",
                bio: "Former software engineer and passionate home cook who wanted to combine AI and food."
              },
              {
                name: "Maya Johnson",
                role: "Head Chef & Food Scientist",
                image: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=facearea&facepad=2&q=60&w=300&h=300",
                bio: "Culinary institute graduate with expertise in flavor combinations and food science."
              },
              {
                name: "David Kim",
                role: "AI Engineer",
                image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=facearea&facepad=2&q=60&w=300&h=300",
                bio: "Specializes in natural language processing and culinary-focused AI models."
              },
              {
                name: "Sophia Martinez",
                role: "Nutritionist",
                image: "https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=facearea&facepad=2&q=60&w=300&h=300",
                bio: "Registered dietitian who ensures all generated recipes meet nutritional standards."
              }
            ].map((member, index) => (
              <motion.div
                key={index}
              ...
              >
                <div className="mb-4 overflow-hidden rounded-full mx-auto w-32 h-32 bg-gray-100">
                  <img 
                    src={member.image} 
                    alt={member.name} 
